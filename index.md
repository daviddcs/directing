...
THIS IS (OWN C/S) WITH AN (QRA/CAS/CSAR) SCRAMBLE
FOR (AIRBASE) TIME IS _______ ZULU, I AUTHENTICATE ______
SCRAMBLE (C/S) (AMT) (A/C TYPE)
VECTOR (XXX), AT (ALTITUDE)
--- AIR TO GROUND ---
PROCEED TO (AREA/COORDINATES/KILLBOX)
--- FOR QRA ---
TOI IS (VECTOR) (MILES) (FROM) HEADING (XXX) AT (XX
THOUSANDS)
---
CONTACT (C/S) ON (FREQ) BACKUP (FREQ) WHEN
AIRBORNE FOR COMMAND AND CONTROL.
REMARKS
